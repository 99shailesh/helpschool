...
if(isset($_SESSION['msg']))
{
    ...
    if($_SESSION['msg']=='Message has been sent')
    {
      $query2='DELETE FROM `application` WHERE id='.$_SESSION['id'];
...
$query="select * from  application where t_name='$tnmae'";
$result=mysqli_query($con,$query);
...
<tr>
  ...
  <a href="viewstudentpro.php?id='.$row['id'].'" class="button">View Apllication</a>
  </td>
</tr>';
	}
}
