...
<div class="row">
    <div class="card">
      <ul class="list">
                <li style="margin:2px"><a href="logout.php" class="button" >LOG-OUT</a></li>
                <li style="margin:2px"><a href="s_profile.php" class="button">Update Profile</a></li>
                <li style="margin:2px"><a href="#application" class="button">Applications</a></li>
		            <li style="margin:2px"><form class="example" action="search.php" style="margin:auto;max-width:300px" method="post">
                <input type="text" style="margin-top:2px;" placeholder="Search for trust.." name="search">
		            <button type="submit" style="width:20%; margin-top:2px;"><i class="fa fa-search"></i></button>
                </form></li>
      </ul>
      <br>
      <br>
                ...
                if(!($sc2d2))
                  ...
                  else
                  {
                    $sc2d1=($sc2d1/$sc2d2)*100;
                       echo '<div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:'.$sc2d1.'%">
                        <div class="w3-center w3-text-white">'.$sc2d1.'%</div>';
    ...
    <div class="card" style="height:800px; width:100%">
        <div class="w3-col w3-container m2"></div>
            ...
            <div class="w3-col w3-container m8">
                ...
                <br>
                <div class="row">
                    <div class="col-75"><input type="text" name="name" id="name" placeholder="trust name"></div>
                </div>     
                 <b><hr></b>
                <div class="row">
                    
                    <div class="col-75"><input type="text" name="mail" id="mail" placeholder="eg:123abc@gmail.com"></div>
                </div>
                <b><hr></b>

                <div class="row">
                    <div class="col-25" style="float:left"><label</label></div>
                    <div class="col-75"><input type="text" name="amount" id="amount" placeholder="eg:10000Rs"></div>
                </div>
                  <hr>
   
                <b><hr></b>
                <div class="row">
                    <div class="col-75"><input type="text" name="description" id="description" placeholder="Describe yourself...."></div>
                </div>
                ...
                <div class="row">
                    <div class="col-100">
                    <a href=" " style="float:right; padding-bootom:2px;width:100%; border:none;"><button class="btn" type="submit">APPLY</button></a>
                    </div>
                </div> 
                <form>
...
<?php
          ...
          {
                 echo '<script>alert("'.$_SESSION["amsg"].'");</script>';
          }
                 unset($_SESSION['amsg']);
?>
