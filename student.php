    ...
    <div class="card">
      <ul class="list">
                ...
                <li style="margin:2px"><a href="#application" class="button">Applications</a></li>
		            <li><form class="example" action="search.php" style="margin:auto;max-width:300px" method="post">
                <input type="text" placeholder="Search for trust.." name="search">
    ...
    <div class="card" style="height:800px; width:100%">
        <div class="w3-col w3-container m2"></div>
            ...
            <div class="w3-col w3-container m8">
                ...
                <div class="row">
                    <div class="col-75">
                        <textarea id="description" name="description" placeholder="Describe yourself...." rows="6"></textarea> 
                    </div>
                </div>    
                ...
                <div class="row">
                    <div class="col-100">
                    <a href=" " style="float:left; padding-bootom:2px"><button class="btn" type="submit">APPLY</button></a>
                    </div>
                </div> 
                <form>
