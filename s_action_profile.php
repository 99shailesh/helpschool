...
$query="insert into profile values ('$fname','$cntatc','$add','$school1','$s1d1','$s1d2','$school2','$s2d1','$s2d2','$school3','$s3d1','$s3d2','$school4','$s4d1','$s4d2',$sc1d1,$sc1d2,$sc2d1,$sc2d2,$sc3d1,$sc3d2,$sc4d1,$sc4d2,'$description')";
