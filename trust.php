...
$query='select * from t_profile_action where fname="'.$_SESSION['usr'].'"';
...
<div class="row">
    <div class="card">
      <ul class="list">
                <li style="margin:2px"><a href="logout.php" class="button" style="color:red">LOG-OUT</a></li>
                <li><a href="t_profile.php" class="button" style="margin:2px;">Update Profile</a></li>
                <li><a href="#application" class="button">View Applications</a></li>
      </ul>
      <br>
      <br>
    </div>  
...
<div class="row">
    ...
    <div class="w3-col w3-container m8"> 
            <div class="card">
            <p><i class="fa fa-money fa-fw w3-margin-right w3-large w3-text-teal" style="float:left; padding-right:5px"></i>eg.Max-amount:1000Rs</p>
            <hr>
            ...
            <p>we provide funds to womens only gnfmlk get_object_varsseiroi
                 kkk rkksi nfskj ls, l, 
            </p>
...
<!--apllication-->
<script>
    var car = document.getElementById('name');
    var tot = document.getElementById('amount');
    var sold = document.getElementById('description');
</script>  
<?php 
$con=mysqli_connect("localhost","root","","helpschool");
if($con==false)
...
if (mysqli_num_rows($result) > 0)
{
  ...
  {
      echo '<script> var array='.json_encode($row).';</script>';
?>
   <script>
   function() {
          ...
          <div class="card" style="margin-bottom:5px">
            <h3 id="#application"><u>Applications</u></h3>
              <div class="row">
                  ...
                  <div class="col-75"><p id="name">eg. parth</p></div>
              </div>     
               <b><hr></b>
              <div class="row">
                  <div class="col-25" style="float:left"><label>Amount:</label></div>
                  <div class="col-75" id="amount"><p>eg. 25000</p></div>
              </div>
              <b><hr></b>
              <div class="row">
                  <div class="col-25" style="float:left"><label>Description:</label></div>
                  <div class="col-75" id="description"><p>eg. stdying at VJTI...</p></div>
              </div>

              <b><hr></b>
            <ul style="list-style-type:none">
            <li><a href=" " class="button" style="float:left; padding-bootom:2px">View profile</a></li>
            <li><a href=" " class="button" style="float:left; padding-bootom:2px">Grant Scholarship</a></li>
            <li><a href=" " class="button" style="float:left; padding-bootom:2px">Next</a></li>
          </ul>
          <br>
          <br>
          <br>
